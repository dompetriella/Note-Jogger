...
List<List<Widget>> introMusicNotation = [
  [
    ...
    const InformationWindowText(
        text:
            "Notes can have one of 8 values, A through G of the English alphabet, repeating that pattern as the pitch increases. The note itself doesn't tell you much, however, unless placed on a staff")
  ],
  [
