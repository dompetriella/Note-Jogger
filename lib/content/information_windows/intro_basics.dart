...
List<List<Widget>> introBasicsContent = [
  [
    ...
    const InformationWindowText(
      text:
          'The idea behind Note Jogger is to make learning music and music theory as of a game as possible.',
    ),
    const InformationWindowText(
        text:
    ...
    const InformationWindowText(
        text:
            '''You can use training mode (current mode) to sharpen your skills and learn about the basics of reading/playing music or 
go for a high ranking in the ranked mode that tests your knowledge and speed at identifying notes.'''),
  ...
  [
    ...
    InformationWindowText(
        text:
            'Click one of the buttons that corresponds to the note displayed on the staff to see if that guess is correct or not.  You will receieve roughly $GLOBAL_normal_quiz_amount questions but that amount may vary'),
    const InformationWindowText(
        text:
            'In training mode, the time you take the click the button is recorded, but only for your reference at the end of the jog, and the amount of correct answers you made will be displayed at the results page'),
    const InformationWindowText(
        text:
  ...
  [
    ...
    InformationWindowSubtitle(text: 'Lives'),
    InformationWindowText(
      text:
